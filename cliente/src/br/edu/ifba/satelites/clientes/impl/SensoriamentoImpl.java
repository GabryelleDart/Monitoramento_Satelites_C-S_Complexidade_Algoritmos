...
public class SensoriamentoImpl implements Sensoriamento<Leitura> {
    private static final int TEMPERATURA_BRILHO_NORMAL = 60; // Temperatura ambiente típica das flores, em graus Celsius
    ...
    public List<Leitura> gerar(int totalLeituras) {
        ...
        for (int i = 0; i < totalLeituras; i++) {
            // O(1)
            int oscilacao = TEMPERATURA_BRILHO_NORMAL * randomizador.nextInt(OSCILACAO_MAXIMA_TEMPERATURA)/100;
